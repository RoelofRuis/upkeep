...
func Bootstrap(
	...
	router.Register("quotum", infra.Description{Base: "Adjust quotum", Extra: "Only first day of selection"}, app.Handle(HandleQuotum))
	...
	router.Register("conf quotum", infra.Description{Base: "Edit daily quotum"}, app.Handle(HandleDayQuotum))
